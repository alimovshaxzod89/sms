<template>
  ...
  const paginationConfig = computed(() => ({
    ...
    total: searchValue.value 
      ? examsData.filter(exam => 
          exam.subject.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          exam.class.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          exam.teacher.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          exam.date.toLowerCase().includes(searchValue.value.toLowerCase())
        ).length
      : examsData.length,
  ...
  const handleDelete = (record) => {
    console.log('Delete exam:', record);
