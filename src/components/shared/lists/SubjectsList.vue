  ...
  const paginationConfig = computed(() => ({
    ...
    total: searchValue.value 
      ? subjectsData.filter(subject => 
          subject.name.toLowerCase().includes(searchValue.value.toLowerCase()) ||
          subject.teachers.some(teacher => teacher.toLowerCase().includes(searchValue.value.toLowerCase()))
        ).length
      : subjectsData.length,
